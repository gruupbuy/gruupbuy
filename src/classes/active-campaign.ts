...
export default class ActiveCampaign extends Campaign {
  constructor (public imageUrl: string, public campaignTitle: string, public specificationLink: string, public campaignData: {key: string; value: string | number}[], public unitPriceInCents: number, public unit: string, public score: string, public daysLeft: number, public pickUpLocation: string, public organizer: string, public quantity: number, public shouldIncludeUnitsInTitle = false) {
